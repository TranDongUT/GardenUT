            ...
            <div class="bottom-header">
                ...
                <div class="header-content">    
                    <ul class="nav">
                        ...
                        <a class="search-btn" href=""><i class="ti-search"></i></a>
                    </ul>
                </div>
            </div>
        ...
        <div id="content" >
            ...
            <div id="contact" class="content-section">
                ...
                <div class="row contact">                
                    <div class="col-2 input-box col-mobile">
